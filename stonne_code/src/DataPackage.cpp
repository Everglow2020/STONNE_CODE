...
DataPackage::DataPackage(size_t size_package, data_t data, operand_t data_type, id_t source,traffic_t traffic_type, unsigned int unicast_dest,unsigned int row_index,unsigned int col_index) : 
DataPackage(size_package, data, data_type, source, traffic_type) {
    assert(traffic_type == UNICAST);
    this->unicast_dest = unicast_dest;
}
...
DataPackage::DataPackage(size_t size_package, data_t data, operand_t data_type, id_t source,traffic_t traffic_type, bool* dests, unsigned int n_dests) : 
DataPackage(size_package, data, data_type, source, traffic_type) {
    this->dests = dests;
    this->n_dests = n_dests;
}
DataPackage::DataPackage(size_t size_package, data_t data, operand_t data_type, id_t source,traffic_t traffic_type, bool* dests, unsigned int n_dests,unsigned int row_index,unsigned int col_index) :
DataPackage(size_package, data, data_type, source, traffic_type) {
    this->dests = dests;
    this->n_dests = n_dests;
}
...
//psum package
DataPackage::DataPackage(size_t size_package, data_t data, operand_t data_type, id_t source, unsigned int VN, adderoperation_t operation_mode): 
DataPackage(size_package, data, data_type, source) {
    this->VN = VN;
    this->operation_mode = operation_mode;
}
DataPackage::DataPackage(size_t size_package, data_t data, operand_t data_type, id_t source, unsigned int VN, adderoperation_t operation_mode,unsigned int row_index,unsigned int col_index): 
DataPackage(size_package, data, data_type, source) {
    this->VN = VN;
    this->operation_mode = operation_mode;
}
