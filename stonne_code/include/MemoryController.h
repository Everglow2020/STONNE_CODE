...
public:
    ...
    virtual void setSparseMetadata(metadata_address_t MK_metadata, metadata_address_t KN_metadata, metadata_address_t output_metadata,metadata_address_t MK_rowptr,metadata_address_t MK_rowindex,metadata_address_t MK_colindex,metadata_address_t KN_rowptr,metadata_address_t KN_rowindex,metadata_address_t KN_colindex,metadata_address_t output_rowptr,metadata_address_t output_rowindex,metadata_address_t output_colindex) {assert(false);}
